...
class ImageCreator():
    ...
    def __init__(self):
        ...
        if len(sys.argv) < 1:
            save_dir = rospy.get_param('/home/handscan_workspace/handscan_ws/src/my_task')
            filename = rospy.get_param('/home/handscan_workspace/handscan_ws/src/my_task')
            rospy.loginfo("Bag filename = %s", sensor.bag)

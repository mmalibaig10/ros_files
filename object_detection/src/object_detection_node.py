...
def main ():
    ...
    detect = ObjectDetection(pub1, pub2, pub3, pub4, pub5, pub6)
    pub6 = rospy.Publisher ('laserPointCloud', PointCloud2, queue_size=1)
    self.clPub = rospy.Publisher("/velodyne_point", PointCloud2, detect.callback_cloud)
    self.laserSub = rospy.Subscriber ("/scan", LaserScan, detect.callback_cloud)
    rospy.spin()
